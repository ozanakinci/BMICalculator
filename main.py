...
def info():
    messagebox.showinfo('Info', 'You can calculate your bmi.')
...
age = Label(frame, text="Select Your Age Range:", fg='blue')
age.grid(row=2, column=1)

frame2 = Frame(frame)
frame2.grid(row=2, column=2, pady=10)

under18 = Radiobutton(frame2, text="Under 18 years", variable=var, value=1, state=DISABLED)
